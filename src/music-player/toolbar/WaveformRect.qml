...
Rectangle {
    ...
    function onAudioDataChanged(pointList) {
        ...
        console.warn("onAudioDataChanged called, pointList.length:", pointList.length)
        ...
        console.warn("pointCount:", pointCount, "step:", step, "poolInitialized:", poolInitialized)
        ...
        if (pointList.length === 0) {
            ...
            console.warn("Creating waveform curves for", pointCount, "points")
        ...
        console.warn("Final pathElements count:", maskPath.pathElements.length)
